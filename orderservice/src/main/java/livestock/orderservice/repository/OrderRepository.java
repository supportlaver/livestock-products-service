...
public class OrderRepository {
    ...
    public List<Order> findWithFetchJoin() {
        List<Order> all = em.createQuery("select o from Order o join fetch o.member m join fetch o.delivery d", Order.class)
                .getResultList();
        return all;
    }
}
